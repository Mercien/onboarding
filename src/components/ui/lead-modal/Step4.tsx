    ...
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <textarea
          ...
          className="w-full bg-navy-light border border-white/12 rounded-lg px-4 py-3 text-white placeholder:text-muted min-h-[120px] focus:border-brand-blue-light outline-none transition-all resize-none"
        />
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  currentPref === pref.id
                    ? "bg-brand-blue-light/10 border-brand-blue-light text-white"
                    : "bg-navy-light border-white/7 text-muted hover:border-white/20"
                )}
              >
                <Icon size={20} className={currentPref === pref.id ? "text-brand-blue-light" : "text-muted"} />
      ...
      <div className="flex items-start gap-3 py-2">
        <input
          ...
          type="checkbox"
          id="agreement"
          className="mt-1 w-4 h-4 rounded border-white/12 bg-navy-light text-brand-blue-light focus:ring-brand-orange transition-all"
        />
