...
export const metadata: Metadata = {
  title: "Growth Insights & Strategic Frameworks | Brands Digitals",
  description: "Read our latest technical reports, design systems breakdowns, and marketing architectures engineered for the African digital ecosystem.",
};
  ...
  return (
    <main className="min-h-screen bg-navy text-foreground">
      ...
      <section className="relative pt-40 pb-20 px-6 md:px-16 overflow-hidden border-b border-white/7 bg-gradient-to-b from-navy to-navy-mid">
        <div className="absolute top-[-100px] right-[-80px] w-[500px] h-[500px] bg-brand-blue-light/12 rounded-full blur-[100px] pointer-events-none" />
        <div className="absolute bottom-[-100px] left-[-150px] w-[600px] h-[600px] bg-brand-blue-light/10 rounded-full blur-[120px] pointer-events-none" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-end">
            <div className="lg:col-span-7">
              ...
              <h1 className="text-[40px] sm:text-5xl md:text-6xl lg:text-[80px] font-display font-extrabold tracking-tighter leading-[1] md:leading-[0.9] mt-6 break-words max-w-full">
                Transformation <span className="text-brand-blue-light">Insights</span>.
              </h1>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {posts.map((post) => (
                <Link
                  ...
                  className="group bg-navy-card border border-white/7 rounded-2xl overflow-hidden hover:border-brand-blue-light/30 transition-all duration-300 hover:translate-y-[-4px]"
                >
                  ...
                  <div className="p-8">
                    ...
                    <h3 className="text-xl font-bold text-white mb-4 tracking-tight group-hover:text-brand-blue-light transition-colors">
                      {post.title}
                    </h3>
                    <p className="text-sm text-muted font-light leading-relaxed mb-8">
                      {post.excerpt}
                    </p>
                    <div className="flex items-center gap-2 text-xs font-bold text-brand-blue-light uppercase tracking-widest">
